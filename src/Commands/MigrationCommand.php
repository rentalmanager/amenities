...
class MigrationCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'rm:migrate-amenities';
     ...
     * @var string
     */
    protected $description = 'Creates a migration for the amenities package.';
     ...
     * @var string
     */
    protected $migrationSuffix = 'rental_manager_amenities_setup_tables';
    ...
    public function handle()
    {
        ...
        $this->line('');
        $this->info("Rental Manager Amenities Migration Creation.");
        $this->line('');
    ...
    protected function createMigration()
    {
        ...
        $output = $this->laravel->view
            ->make('amenities::migration')
            ->with(['amenities' => Config::get('amenities')])
            ->render();
    ...
    {
        $tables = Collection::make(Config::get('amenities.tables'))->sort();
    ...
    protected function getExistingMigrationsWarning(array $existingMigrations)
    {
        if (count($existingMigrations) > 1) {
            $base = "Amenities migrations already exist.\nFollowing files were found: ";
        } else {
            $base = "Amenities migration already exists.\nFollowing file was found: ";
        }
